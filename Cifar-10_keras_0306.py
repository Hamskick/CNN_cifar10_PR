...
# plt.figure(figsize=(8,6))       #정규화전 이미지
...
# plt.figure(figsize=(8,6))          #정규화 후 이미지
...
# 모델 학습하기
history=model.fit(x_train_fold, y_train_fold, batch_size=len(x_train_fold), epochs=150, validation_data=(x_val_fold, y_val_fold))
