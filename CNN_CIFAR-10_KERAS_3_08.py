...
cnn.add(Dense(1700, activation='relu', kernel_initializer=He_normal))       #은닉층, 1700개의 노드를 지니며 활성함수 'relu'
cnn.add(Dropout(0.2))

cnn.add(Dense(1200, activation='relu', kernel_initializer=He_normal))      #은닉층, 1200개의 노드를 지니며 활성함수 'relu'
cnn.add(Dropout(0.2))

# model.add(tf.keras.layers.Dense(750, activation='relu',   kernel_initializer=He_normal))       #은닉층, 750개의 노드를 지니며 활성함수 'relu'
# model.add(Dropout(0.2))

cnn.add(Dense(350, activation='relu',  kernel_initializer=He_normal))        #은닉층, 350개의 노드를 지니며 활성함수 'relu'
cnn.add(Dropout(0.2))

cnn.add(Dense(150, activation='relu', kernel_initializer=He_normal))        #은닉층, 150개의 노드를 지니며 활성함수 'relu' 따라서 은닉층 5개의 구조이다
cnn.add(Dropout(0.2))
